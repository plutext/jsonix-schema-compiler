// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_com_microsoft_schemas_office_drawing_x2010_diagram]. Do not edit.
...
export interface CTBoolean {
  TYPE_NAME?: 'org_docx4j_com_microsoft_schemas_office_drawing_x2010_diagram.CTBoolean';
  val?: boolean;
}

export type CNvPrElement = TypedNamedValue<Dep_org_docx4j_dml.CTNonVisualDrawingProps>;

export type RecolorImgElement = TypedNamedValue<CTBoolean>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = CNvPrElement | RecolorImgElement;

/** The Jsonix mapping [org_docx4j_com_microsoft_schemas_office_drawing_x2010_diagram] exported by the module's JavaScript file. */
export declare const org_docx4j_com_microsoft_schemas_office_drawing_x2010_diagram: JsonixMapping<RootElement>;
