// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_com_microsoft_schemas_office_drawing_x2010_picture]. Do not edit.
...
export type ExtLstElement = TypedNamedValue<Dep_org_docx4j_dml.CTOfficeArtExtensionList>;

export type StyleElement = TypedNamedValue<Dep_org_docx4j_dml.CTShapeStyle>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = ExtLstElement | StyleElement;

/** The Jsonix mapping [org_docx4j_com_microsoft_schemas_office_drawing_x2010_picture] exported by the module's JavaScript file. */
export declare const org_docx4j_com_microsoft_schemas_office_drawing_x2010_picture: JsonixMapping<RootElement>;
