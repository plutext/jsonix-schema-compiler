// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_dml_compatibility]. Do not edit.
...
export interface CTCompat {
  TYPE_NAME?: 'org_docx4j_dml_compatibility.CTCompat';
  spid: string;
}

export type LegacyDrawingElement = TypedNamedValue<CTCompat>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = LegacyDrawingElement;

/** The Jsonix mapping [org_docx4j_dml_compatibility] exported by the module's JavaScript file. */
export declare const org_docx4j_dml_compatibility: JsonixMapping<RootElement>;
