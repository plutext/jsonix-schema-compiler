// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_pptx4j_com_microsoft_schemas_office_powerpoint_x201703_main]. Do not edit.
...
export interface CTTracksInfo {
  TYPE_NAME?: 'org_pptx4j_com_microsoft_schemas_office_powerpoint_x201703_main.CTTracksInfo';
  trackLst?: CTTrackList;
  displayLoc: STDisplayLocation;
}

export type STDisplayLocation = 'media' | 'slide';

export type TracksInfoElement = TypedNamedValue<CTTracksInfo>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = TracksInfoElement;

/** The Jsonix mapping [org_pptx4j_com_microsoft_schemas_office_powerpoint_x201703_main] exported by the module's JavaScript file. */
export declare const org_pptx4j_com_microsoft_schemas_office_powerpoint_x201703_main: JsonixMapping<RootElement>;
