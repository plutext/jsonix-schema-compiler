...
export interface CTAnchorClientData {
  ...
  readonly PARENT?: CTAbsoluteAnchor | CTOneCellAnchor | CTTwoCellAnchor;
...
export interface CTConnector {
  ...
  readonly PARENT?: CTAbsoluteAnchor | CTGroupShape | CTOneCellAnchor | CTTwoCellAnchor;
...
export interface CTMarker {
  ...
  readonly PARENT?: CTOneCellAnchor | CTTwoCellAnchor | Dep_org_xlsx4j_sml.CTObjectAnchor;
  col: number;
  colOff: number;
  row: number;
  rowOff: number;
