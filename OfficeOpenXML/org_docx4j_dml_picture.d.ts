// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_dml_picture]. Do not edit.
...
export interface CTPictureNonVisual {
  TYPE_NAME?: 'org_docx4j_dml_picture.CTPictureNonVisual';
  cNvPr: Dep_org_docx4j_dml.CTNonVisualDrawingProps;
  cNvPicPr: Dep_org_docx4j_dml.CTNonVisualPictureProperties;
}

export interface Pic {
  TYPE_NAME?: 'org_docx4j_dml_picture.Pic';
  nvPicPr: CTPictureNonVisual;
  blipFill: Dep_org_docx4j_dml.CTBlipFillProperties;
  spPr: Dep_org_docx4j_dml.CTShapeProperties;
}

export type PicElement = TypedNamedValue<Pic>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = PicElement;

/** The Jsonix mapping [org_docx4j_dml_picture] exported by the module's JavaScript file. */
export declare const org_docx4j_dml_picture: JsonixMapping<RootElement>;
