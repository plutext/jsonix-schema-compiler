// Generated by jsonix-schema-compiler: Jsonix mappings of the module [org_docx4j_dml_wordprocessingDrawing] as an ES module. Do not edit.
export const org_docx4j_dml_wordprocessingDrawing = {
