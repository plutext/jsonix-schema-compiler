// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_pptx4j_com_microsoft_schemas_office_powerpoint_x2016_slidezoom]. Do not edit.
...
export interface CTSlideZoom {
  TYPE_NAME?: 'org_pptx4j_com_microsoft_schemas_office_powerpoint_x2016_slidezoom.CTSlideZoom';
  sldZmObj: CTSlideZoomObject;
...
export type SldZmElement = TypedNamedValue<CTSlideZoom>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = SldZmElement;

/** The Jsonix mapping [org_pptx4j_com_microsoft_schemas_office_powerpoint_x2016_slidezoom] exported by the module's JavaScript file. */
export declare const org_pptx4j_com_microsoft_schemas_office_powerpoint_x2016_slidezoom: JsonixMapping<RootElement>;
