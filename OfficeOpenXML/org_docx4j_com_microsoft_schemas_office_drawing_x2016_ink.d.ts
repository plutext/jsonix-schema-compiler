// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_com_microsoft_schemas_office_drawing_x2016_ink]. Do not edit.
...
export type STExtendedBrushPropertyName = 'inkEffects' | 'anchorX' | 'anchorY' | 'scaleFactor';

export type STInkEffectsType = 'none' | 'pencil' | 'rainbow' | 'galaxy' | 'gold' | 'silver' | 'lava' | 'ocean' | 'rosegold' | 'bronze';

/** The Jsonix mapping [org_docx4j_com_microsoft_schemas_office_drawing_x2016_ink] exported by the module's JavaScript file. */
export declare const org_docx4j_com_microsoft_schemas_office_drawing_x2016_ink: JsonixMapping;
