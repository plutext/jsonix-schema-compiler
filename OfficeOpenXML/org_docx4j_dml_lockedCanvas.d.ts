// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_dml_lockedCanvas]. Do not edit.
...
export type LockedCanvasElement = TypedNamedValue<Dep_org_docx4j_dml.CTGvmlGroupShape>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = LockedCanvasElement;

/** The Jsonix mapping [org_docx4j_dml_lockedCanvas] exported by the module's JavaScript file. */
export declare const org_docx4j_dml_lockedCanvas: JsonixMapping<RootElement>;
