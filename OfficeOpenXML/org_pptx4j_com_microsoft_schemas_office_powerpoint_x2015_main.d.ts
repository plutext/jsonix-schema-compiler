// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_pptx4j_com_microsoft_schemas_office_powerpoint_x2015_main]. Do not edit.
...
export interface CTDesignElement {
  TYPE_NAME?: 'org_pptx4j_com_microsoft_schemas_office_powerpoint_x2015_main.CTDesignElement';
  val?: boolean;
}

export type DesignElemElement = TypedNamedValue<CTDesignElement>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = DesignElemElement;

/** The Jsonix mapping [org_pptx4j_com_microsoft_schemas_office_powerpoint_x2015_main] exported by the module's JavaScript file. */
export declare const org_pptx4j_com_microsoft_schemas_office_powerpoint_x2015_main: JsonixMapping<RootElement>;
