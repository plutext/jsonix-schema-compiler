// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_com_microsoft_schemas_office_x2006_keyEncryptor_certificate]. Do not edit.
...
export type EncryptedKeyElement = TypedNamedValue<CTCertificateKeyEncryptor>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = EncryptedKeyElement;

/** The Jsonix mapping [org_docx4j_com_microsoft_schemas_office_x2006_keyEncryptor_certificate] exported by the module's JavaScript file. */
export declare const org_docx4j_com_microsoft_schemas_office_x2006_keyEncryptor_certificate: JsonixMapping<RootElement>;
