// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_com_microsoft_schemas_office_drawing_x2014_chart_ac]. Do not edit.
...
export type MultiLvlStrLitElement = TypedNamedValue<Dep_org_docx4j_dml_chart.CTMultiLvlStrData>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = MultiLvlStrLitElement;

/** The Jsonix mapping [org_docx4j_com_microsoft_schemas_office_drawing_x2014_chart_ac] exported by the module's JavaScript file. */
export declare const org_docx4j_com_microsoft_schemas_office_drawing_x2014_chart_ac: JsonixMapping<RootElement>;
