// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_docProps_coverPageProps]. Do not edit.
...
export interface CoverPageProperties {
  TYPE_NAME?: 'org_docx4j_docProps_coverPageProps.CoverPageProperties';
  publishDate: string;
  _abstract: string;
...
export type CoverPagePropertiesElement = TypedNamedValue<CoverPageProperties>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = CoverPagePropertiesElement;

/** The Jsonix mapping [org_docx4j_docProps_coverPageProps] exported by the module's JavaScript file. */
export declare const org_docx4j_docProps_coverPageProps: JsonixMapping<RootElement>;
