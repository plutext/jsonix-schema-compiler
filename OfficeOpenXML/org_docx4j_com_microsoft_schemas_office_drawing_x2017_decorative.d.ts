// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_com_microsoft_schemas_office_drawing_x2017_decorative]. Do not edit.
...
export interface CTDecorative {
  TYPE_NAME?: 'org_docx4j_com_microsoft_schemas_office_drawing_x2017_decorative.CTDecorative';
  val?: boolean;
}

export type DecorativeElement = TypedNamedValue<CTDecorative>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = DecorativeElement;

/** The Jsonix mapping [org_docx4j_com_microsoft_schemas_office_drawing_x2017_decorative] exported by the module's JavaScript file. */
export declare const org_docx4j_com_microsoft_schemas_office_drawing_x2017_decorative: JsonixMapping<RootElement>;
