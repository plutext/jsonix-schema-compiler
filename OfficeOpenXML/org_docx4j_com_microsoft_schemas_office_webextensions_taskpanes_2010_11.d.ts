// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_com_microsoft_schemas_office_webextensions_taskpanes_2010_11]. Do not edit.
...
export interface CTOsfTaskpanes {
  TYPE_NAME?: 'org_docx4j_com_microsoft_schemas_office_webextensions_taskpanes_2010_11.CTOsfTaskpanes';
  taskpane?: CTOsfTaskpane[];
}

export type TaskpanesElement = TypedNamedValue<CTOsfTaskpanes>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = TaskpanesElement;

/** The Jsonix mapping [org_docx4j_com_microsoft_schemas_office_webextensions_taskpanes_2010_11] exported by the module's JavaScript file. */
export declare const org_docx4j_com_microsoft_schemas_office_webextensions_taskpanes_2010_11: JsonixMapping<RootElement>;
