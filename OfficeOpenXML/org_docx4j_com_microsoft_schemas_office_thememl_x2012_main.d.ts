// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_com_microsoft_schemas_office_thememl_x2012_main]. Do not edit.
...
export type ThemeFamilyElement = TypedNamedValue<CTThemeFamily>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = ThemeFamilyElement;

/** The Jsonix mapping [org_docx4j_com_microsoft_schemas_office_thememl_x2012_main] exported by the module's JavaScript file. */
export declare const org_docx4j_com_microsoft_schemas_office_thememl_x2012_main: JsonixMapping<RootElement>;
