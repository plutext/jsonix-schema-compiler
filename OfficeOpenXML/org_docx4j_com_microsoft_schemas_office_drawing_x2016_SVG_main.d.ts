// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_com_microsoft_schemas_office_drawing_x2016_SVG_main]. Do not edit.
...
export interface CTSVGBlip {
  TYPE_NAME?: 'org_docx4j_com_microsoft_schemas_office_drawing_x2016_SVG_main.CTSVGBlip';
  embed?: string;
  link?: string;
}

export type SvgBlipElement = TypedNamedValue<CTSVGBlip>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = SvgBlipElement;

/** The Jsonix mapping [org_docx4j_com_microsoft_schemas_office_drawing_x2016_SVG_main] exported by the module's JavaScript file. */
export declare const org_docx4j_com_microsoft_schemas_office_drawing_x2016_SVG_main: JsonixMapping<RootElement>;
