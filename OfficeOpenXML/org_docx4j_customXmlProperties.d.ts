// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_customXmlProperties]. Do not edit.
...
export interface DatastoreItem {
  TYPE_NAME?: 'org_docx4j_customXmlProperties.DatastoreItem';
...
export type DatastoreItemElement = TypedNamedValue<DatastoreItem>;

export type SchemaRefsElement = TypedNamedValue<SchemaRefs>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = DatastoreItemElement | SchemaRefsElement;
...
/** The Jsonix mapping [org_docx4j_customXmlProperties] exported by the module's JavaScript file. */
export declare const org_docx4j_customXmlProperties: JsonixMapping<RootElement>;
