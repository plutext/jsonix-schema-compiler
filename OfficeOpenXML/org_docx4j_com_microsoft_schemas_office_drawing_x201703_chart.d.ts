// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_com_microsoft_schemas_office_drawing_x201703_chart]. Do not edit.
...
export interface CTDataDisplayOptions16 {
  TYPE_NAME?: 'org_docx4j_com_microsoft_schemas_office_drawing_x201703_chart.CTDataDisplayOptions16';
  dispNaAsBlank?: CTBooleanFalse;
}

export type DataDisplayOptions16Element = TypedNamedValue<CTDataDisplayOptions16>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = DataDisplayOptions16Element;

/** The Jsonix mapping [org_docx4j_com_microsoft_schemas_office_drawing_x201703_chart] exported by the module's JavaScript file. */
export declare const org_docx4j_com_microsoft_schemas_office_drawing_x201703_chart: JsonixMapping<RootElement>;
