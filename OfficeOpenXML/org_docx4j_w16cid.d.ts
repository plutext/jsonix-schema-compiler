// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_w16cid]. Do not edit.
...
export interface CTCommentsIds {
  TYPE_NAME?: 'org_docx4j_w16cid.CTCommentsIds';
  commentId?: CTCommentId[];
  ignorable?: string;
}

export type CommentsIdsElement = TypedNamedValue<CTCommentsIds>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = CommentsIdsElement;

/** The Jsonix mapping [org_docx4j_w16cid] exported by the module's JavaScript file. */
export declare const org_docx4j_w16cid: JsonixMapping<RootElement>;
