// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_pptx4j_com_microsoft_schemas_office_powerpoint_x2016_sectionzoom]. Do not edit.
...
export interface CTSectionZoom {
  TYPE_NAME?: 'org_pptx4j_com_microsoft_schemas_office_powerpoint_x2016_sectionzoom.CTSectionZoom';
  sectionZmObj: CTSectionZoomObject;
...
export type SectionZmElement = TypedNamedValue<CTSectionZoom>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = SectionZmElement;

/** The Jsonix mapping [org_pptx4j_com_microsoft_schemas_office_powerpoint_x2016_sectionzoom] exported by the module's JavaScript file. */
export declare const org_pptx4j_com_microsoft_schemas_office_powerpoint_x2016_sectionzoom: JsonixMapping<RootElement>;
