// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_relationships]. Do not edit.
...
export interface Relationships {
  TYPE_NAME?: 'org_docx4j_relationships.Relationships';
  relationship?: Relationship[];
}

export type RelationshipElement = TypedNamedValue<Relationship>;

export type RelationshipsElement = TypedNamedValue<Relationships>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = RelationshipElement | RelationshipsElement;

/** The Jsonix mapping [org_docx4j_relationships] exported by the module's JavaScript file. */
export declare const org_docx4j_relationships: JsonixMapping<RootElement>;
