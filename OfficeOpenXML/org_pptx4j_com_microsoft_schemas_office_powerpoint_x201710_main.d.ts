// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_pptx4j_com_microsoft_schemas_office_powerpoint_x201710_main]. Do not edit.
...
export interface CTReadonlyRecommended {
  TYPE_NAME?: 'org_pptx4j_com_microsoft_schemas_office_powerpoint_x201710_main.CTReadonlyRecommended';
  val: boolean;
}

export type ReadonlyRecommendedElement = TypedNamedValue<CTReadonlyRecommended>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = ReadonlyRecommendedElement;

/** The Jsonix mapping [org_pptx4j_com_microsoft_schemas_office_powerpoint_x201710_main] exported by the module's JavaScript file. */
export declare const org_pptx4j_com_microsoft_schemas_office_powerpoint_x201710_main: JsonixMapping<RootElement>;
