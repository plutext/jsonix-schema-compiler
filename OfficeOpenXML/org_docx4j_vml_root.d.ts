// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_vml_root]. Do not edit.
...
export interface Xml {
  TYPE_NAME?: 'org_docx4j_vml_root.Xml';
  any: XmlAnyElement[];
}

export type XmlElement = TypedNamedValue<Xml>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = XmlElement;

/** The Jsonix mapping [org_docx4j_vml_root] exported by the module's JavaScript file. */
export declare const org_docx4j_vml_root: JsonixMapping<RootElement>;
