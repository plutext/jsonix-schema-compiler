// Generated by jsonix-schema-compiler: TypeScript declarations for the Jsonix module [org_docx4j_com_microsoft_schemas_office_word_x2012_wordprocessingDrawing]. Do not edit.
...
export interface CTWebVideoPr {
  TYPE_NAME?: 'org_docx4j_com_microsoft_schemas_office_word_x2012_wordprocessingDrawing.CTWebVideoPr';
  embeddedHtml?: string;
  h?: number;
  w?: number;
}

export type WebVideoPrElement = TypedNamedValue<CTWebVideoPr>;

/** Any global element of this mapping, i.e. what an unmarshaller returns. */
export type RootElement = WebVideoPrElement;

/** The Jsonix mapping [org_docx4j_com_microsoft_schemas_office_word_x2012_wordprocessingDrawing] exported by the module's JavaScript file. */
export declare const org_docx4j_com_microsoft_schemas_office_word_x2012_wordprocessingDrawing: JsonixMapping<RootElement>;
