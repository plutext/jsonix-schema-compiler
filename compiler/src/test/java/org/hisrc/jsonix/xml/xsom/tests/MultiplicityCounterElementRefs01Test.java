...
public class MultiplicityCounterElementRefs01Test {
	...
	public void e01a() throws Exception {
		...
		final MClassInfo<NType, NClass> eType = model.getClassInfo("test.Ers01");
		...
		Assert.assertEquals(30, multiplicity.min.intValue());
		Assert.assertEquals(200, multiplicity.max.intValue());
	}
}
