...
public class MultiplicityCounterElementRef01Test {
	...
	public void e01a() throws Exception {
		...
		final MClassInfo<NType, NClass> eType = model.getClassInfo("test.Er01");
		...
		Assert.assertEquals(0, multiplicity.min.intValue());
